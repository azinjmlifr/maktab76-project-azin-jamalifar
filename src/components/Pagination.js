    ...
    <div>
      <ReactPaginate
        ...
        previousLinkClassName={
          " text-[#ffbd07] font-bold hover:text-[#fff] text-2xl"
        }
        nextClassName={
        ...
        breakClassName={
          "border-2 border-[#ffbd07] p-3 mr-3 pt-1 rounded-full h-12 w-12 cursor-pointer text-center font-bold text-[#ffbd07] text-2xl hover:bg-[#ffbd07] hover:text-[#fff]"
        }
      />
    </div>
  );
